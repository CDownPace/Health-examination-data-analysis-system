...
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('ManagerScheduler','UniverseMac2.lan1589034995668',1589036125325,15000);
...
INSERT INTO `QRTZ_TRIGGERS` VALUES ('ManagerScheduler','TASK_CLASS_NAME1','DEFAULT','TASK_CLASS_NAME1','DEFAULT',NULL,1589035000000,-1,5,'PAUSED','CRON',1589034995000,0,NULL,2,''),('ManagerScheduler','TASK_CLASS_NAME2','DEFAULT','TASK_CLASS_NAME2','DEFAULT',NULL,1589035005000,-1,5,'PAUSED','CRON',1589034996000,0,NULL,2,''),('ManagerScheduler','TASK_CLASS_NAME3','DEFAULT','TASK_CLASS_NAME3','DEFAULT',NULL,1589035000000,-1,5,'PAUSED','CRON',1589034996000,0,NULL,2,'');
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-05-09 22:55:31
